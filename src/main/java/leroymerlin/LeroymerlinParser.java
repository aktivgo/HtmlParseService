...
public class LeroymerlinParser implements Parser<ArrayList<Product>> {
    ...
    @Override
    public ArrayList<Product> Parse(@NotNull Document document, ParserSettings parserSettings) throws IOException {
        ...
        for (Element productEl : productsEl) {
            ...
            ArrayList<Feedback> feedbacks = parseFeedbacks(productPath, parserSettings);
    ...
    private @NotNull ArrayList<Feedback> parseFeedbacks(String productPath, @NotNull ParserSettings parserSettings) throws IOException {
        ...
        for (Element feedbackEl : feedbacksEl) {
            ...
            String text = feedbackEl.getElementsByAttributeValue("slot", "review-text").first().ownText();
